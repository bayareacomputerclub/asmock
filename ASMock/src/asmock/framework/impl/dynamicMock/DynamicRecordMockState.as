package asmock.framework.impl.dynamicMock
{
	...
	[ExcludeClass]
	public class DynamicRecordMockState implements IRecordMockState
	{
		...
		public function DynamicRecordMockState(mockObject : Object, repository : MockRepository)
		{
		...
		{
			return new DynamicRecordMockState(_mockObject, _repository);
		}
		...
		{
			return new DynamicReplayMockState(this);
		}
