package asmock.framework.impl.stub
{
	...
	[ExcludeClass]
	public class StubReplayMockState implements IMockState
	{
		private var _errorToThrowOnVerify : Error;
		protected var _proxy : Object;
		protected var _repository : MockRepository;
		
		public function StubReplayMockState(previousState : IRecordMockState)
		{
		...
		{
			return new StubRecordMockState(_proxy, _repository);
		}
		...
		{
			return new StubVerifiedMockState(this);
		}
