package asmock.framework.impl.stub
{
	...
	[ExcludeClass]
	public class StubRecordMockState implements IRecordMockState
	{
		...
		public function StubRecordMockState(mockObject : Object, repository : MockRepository)
		{
		...
		{
			return new StubRecordMockState(_mockObject, _repository);
		}
