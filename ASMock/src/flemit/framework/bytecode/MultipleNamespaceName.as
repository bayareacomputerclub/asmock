...
{
	[ExcludeClass]
	public class MultipleNamespaceName extends Multiname
	{
		private var _name : String;
		private var _namespaceSet : NamespaceSet;
		
		public function MultipleNamespaceName(name : String, namespaceSet : NamespaceSet, kind : uint = MultinameKind.MULTINAME)
		{
			super(kind);
